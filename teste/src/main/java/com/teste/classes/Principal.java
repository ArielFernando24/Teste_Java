...
public class Principal {
    public static void main(String[] args) {
        ...
        for (Funcionario f : funcionarios) {
            ...
            System.out.println("Salário: " + f.getSalario().setScale(2, RoundingMode.HALF_UP).toString().replace('.', ','));
        ...
        if (maisVelho != null) {
            ...
            System.out.println("Funcionário com a maior idade: Nome: " + maisVelho.getNome() + ", Idade: " + idade);
        }
